...
describe('[5][2] SSH-Key Actions', () => {
  ...
  it('[3] click on ssh key and click edit - type a new name', () => {
    ...
    browser.sleep(500);
    element(by.css('#description input')).sendKeys('-RENAMED');
    browser.sleep(500);
    element(by.partialButtonText(page.getLocal('ACTIONS.SAVE'))).click();
    browser.sleep(500);
    expect(element(by.css('[data-test~="kontakt@lukas-kaemmerling.de-RENAMED"] h2')).getText()).toContain('kontakt@lukas-kaemmerling.de-RENAMED');
    expect(element(by.css('[data-test~="kontakt@lukas-kaemmerling.de-RENAMED"] p')).getText()).toContain('83:6e:fe:c0:69:c2:a9:ab:c5:b7:c0:59:03:10:5f:b2');
    element(by.css('[data-test~="kontakt@lukas-kaemmerling.de-RENAMED"]')).click();
    browser.sleep(500);
    element(by.partialButtonText(page.getLocal('ACTIONS.EDIT'))).click();
    browser.sleep(500);
    element(by.css('#description input')).sendKeys(protractor.Key.BACK_SPACE);
    browser.sleep(500);
    element(by.css('#description input')).sendKeys('kontakt@lukas-kaemmerling.de');
    browser.sleep(500);
    element(by.partialButtonText(page.getLocal('ACTIONS.SAVE'))).click();
    browser.sleep(500);
    expect(element(by.css('[data-test~="kontakt@lukas-kaemmerling.de"] h2')).getText()).toContain('kontakt@lukas-kaemmerling.de');
