...
describe('[5][2] SSH-Key Actions', () => {
    ...
    it('[3] click on ssh key and click edit - type a new name', () => {
        ...
        browser.sleep(1000);
        expect(element(by.css('[data-test~="kontakt@lukas-kaemmerling.de-R"] h2')).getText()).toContain(
            'kontakt@lukas-kaemmerling.de-R'
        );
        expect(element(by.css('[data-test~="kontakt@lukas-kaemmerling.de-R"] p')).getText()).toContain(
            '83:6e:fe:c0:69:c2:a9:ab:c5:b7:c0:59:03:10:5f:b2'
        );
