define(['exports', '../core/util/logging.js', './localization.js', '../core/util/browser.js', '../core/util/events.js', '../core/input/keysym.js', '../core/input/keysymdef.js', '../core/input/keyboard.js', '../core/rfb.js', '../core/display.js', './webutil.js'], function (exports, _logging, _localization, _browser, _events, _keysym, _keysymdef, _keyboard, _rfb, _display, _webutil) {
    'use strict';
    ...
    var UI = {
        ...
        * ------v------*/
        ...
        connect: function (event, password) {
          ...
          url += '/' + '?server_id=' + WebUtil.getConfigVar('server_id') + '&token=' + WebUtil.getConfigVar('token');
