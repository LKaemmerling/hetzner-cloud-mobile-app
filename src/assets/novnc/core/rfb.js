define(['exports', './util/logging.js', './util/strings.js', './util/browser.js', './util/eventtarget.js', './display.js', './input/keyboard.js', './input/mouse.js', './websock.js', './des.js', './input/keysym.js', './input/xtscancodes.js', './inflator.js', './encodings.js', './util/polyfill.js'], function (exports, _logging, _strings, _browser, _eventtarget, _display, _keyboard, _mouse, _websock, _des, _keysym, _xtscancodes, _inflator, _encodings) {
    'use strict';
    ...
    function RFB(target, url, options) {
        ...
        this._encHandlers[_encodings.encodings.encodingTight] = RFB.encodingHandlers.TIGHT.bind(this, false);
        this._encHandlers[_encodings.encodings.encodingTightPNG] = RFB.encodingHandlers.TIGHT.bind(this, true);
