...
import {ServerActionsModalModule} from "./actions/server-actions-modal.module";

@NgModule({
  declarations: [ServerListPage, ServerDetailPage, ServerEditModal],
  imports: [
    ...
    TooltipsModule,
    ServerActionsModalModule
  ],
  entryComponents: [ServerListPage, ServerDetailPage, ServerEditModal],
})
