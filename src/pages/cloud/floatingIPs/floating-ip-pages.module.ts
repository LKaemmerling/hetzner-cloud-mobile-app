...
@NgModule({
    declarations: [FloatingIPsPage, FloatingIPPage, editFloatingIpModal, assignToServerModal, addFloatingIPModal],
    imports: [
    ...
    entryComponents: [FloatingIPsPage, FloatingIPPage, editFloatingIpModal, assignToServerModal, addFloatingIPModal],
})
