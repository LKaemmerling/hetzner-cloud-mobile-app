...
export class ServerMetricsPage {
  ...
  constructor(
    ...
    tracking.trackFeature('cloud.server.metrics');
  ...
  public getDiskMetrics() {
    return new Promise((resolve, reject = null) => {
      this.serverApiProvider.getMetrics(this.server.id, 'disk', this.time_start, this.time_end).then(data => {
        this.disk_metrics = [{data: [], label: 'read'}, {data: [], label: 'write'}];
        this.disk_bandwidth_metrics = [{data: [], label: 'read'}, {data: [], label: 'write'}];
        this.disk_labels = [];
  ...
  public getNetworkMetrics() {
    return new Promise((resolve, reject = null) => {
      this.serverApiProvider.getMetrics(this.server.id, 'network', this.time_start, this.time_end).then(data => {
        this.network_pps_metrics = [{data: [], label: 'in'}, {data: [], label: 'out'}];
        this.network_bandwidth_metrics = [{data: [], label: 'in'}, {data: [], label: 'out'}];
